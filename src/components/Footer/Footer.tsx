export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white p-8 rounded-t-2xl">
      <div className="max-w-[1920px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left">
      ...
      <div className="border-t border-white mt-6 pt-4 flex flex-col md:flex-row justify-between items-center text-sm">
